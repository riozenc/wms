...
<meta http-equiv="keywords" content="综合信息管理平台">
<meta http-equiv="description" content="综合信息管理平台">

<!-- 引入ExtJs6.5核心Js -->
<script type="text/javascript" src="scripts/ext-bootstrap.js"></script>
<script type="text/javascript" src="scripts/build/classic/locale/locale-zh_CN.js"></script>
